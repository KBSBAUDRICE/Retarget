...
class BindingsMenu(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        row = layout.row()
        op = row.operator(operators.AlignBone.bl_idname)
...
class VIEW3D_PT_retarget_rename_candidates(bpy.types.Panel):
...
class VIEW3D_PT_retarget_rename_advanced(bpy.types.Panel):
...
class VIEW3D_PT_retarget_retarget(RetargetBasePanel, bpy.types.Panel):
...
class VIEW3D_PT_retarget_retarget_face(RetargetBasePanel, bpy.types.Panel):
    bl_label = "Face"
    bl_options = {'DEFAULT_CLOSED'}
...
class VIEW3D_PT_retarget_retarget_fingers(RetargetBasePanel, bpy.types.Panel):
    bl_label = "Fingers"
    bl_options = {'DEFAULT_CLOSED'}
...
class VIEW3D_PT_retarget_retarget_arms_IK(RetargetBasePanel, bpy.types.Panel):
    bl_label = "Arms IK"
    bl_options = {'DEFAULT_CLOSED'}
...
class VIEW3D_PT_retarget_retarget_arms(RetargetBasePanel, bpy.types.Panel):
    bl_label = "Arms"
...
class VIEW3D_PT_retarget_retarget_spine(RetargetBasePanel, bpy.types.Panel):
    bl_label = "Spine"
...
class VIEW3D_PT_retarget_retarget_leg_IK(RetargetBasePanel, bpy.types.Panel):
    bl_label = "Legs IK"
    bl_options = {'DEFAULT_CLOSED'}
...
class VIEW3D_PT_retarget_retarget_leg(RetargetBasePanel, bpy.types.Panel):
    bl_label = "Legs"
...
class VIEW3D_PT_retarget_retarget_root(RetargetBasePanel, bpy.types.Panel):
    bl_label = "Root"
...
def register_classes():
    ...
    bpy.utils.register_class(VIEW3D_PT_retarget_rename_candidates)
    bpy.utils.register_class(VIEW3D_PT_retarget_rename_advanced)
    
    bpy.utils.register_class(BindFromPanelSelection)
    bpy.utils.register_class(VIEW3D_PT_BindPanel)

    bpy.utils.register_class(VIEW3D_PT_retarget_retarget)
    bpy.utils.register_class(VIEW3D_PT_retarget_retarget_face)
    bpy.utils.register_class(VIEW3D_PT_retarget_retarget_fingers)
    bpy.utils.register_class(VIEW3D_PT_retarget_retarget_arms_IK)
    bpy.utils.register_class(VIEW3D_PT_retarget_retarget_arms)
    bpy.utils.register_class(VIEW3D_PT_retarget_retarget_spine)
    bpy.utils.register_class(VIEW3D_PT_retarget_retarget_leg_IK)
    bpy.utils.register_class(VIEW3D_PT_retarget_retarget_leg)
    bpy.utils.register_class(VIEW3D_PT_retarget_retarget_root)
...
def unregister_classes():
    ...
    bpy.utils.unregister_class(VIEW3D_PT_retarget_rename_candidates)
    bpy.utils.unregister_class(VIEW3D_PT_retarget_rename_advanced)
    
    bpy.utils.unregister_class(BindFromPanelSelection)
    bpy.utils.unregister_class(VIEW3D_PT_BindPanel)

    bpy.utils.unregister_class(VIEW3D_PT_retarget_retarget)
    bpy.utils.unregister_class(VIEW3D_PT_retarget_retarget_root)
    bpy.utils.unregister_class(VIEW3D_PT_retarget_retarget_leg_IK)
    bpy.utils.unregister_class(VIEW3D_PT_retarget_retarget_leg)
    bpy.utils.unregister_class(VIEW3D_PT_retarget_retarget_spine)
    bpy.utils.unregister_class(VIEW3D_PT_retarget_retarget_arms_IK)
    bpy.utils.unregister_class(VIEW3D_PT_retarget_retarget_arms)
    bpy.utils.unregister_class(VIEW3D_PT_retarget_retarget_fingers)
    bpy.utils.unregister_class(VIEW3D_PT_retarget_retarget_face)
