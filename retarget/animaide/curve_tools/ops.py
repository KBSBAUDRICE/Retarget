...
class ANIMAIDERT_OT:
    ...
    def start(self, context, event):
        self.activated = True
        # context.scene.animaidert.tool.show_factor = True
        self.init_mouse_x = event.mouse_x

    def end(self, context):
        self.activated = False
        # context.scene.animaidert.tool.show_factor = False
...
class ANIMAIDERT_OT_ease_to_ease(Operator, ANIMAIDERT_OT):
...
class ANIMAIDERT_OT_ease(Operator, ANIMAIDERT_OT):
    """Transition selected or current keys from the neighboring\n""" \
...
class ANIMAIDERT_OT_blend_ease(Operator, ANIMAIDERT_OT):
...
class ANIMAIDERT_OT_blend_neighbor(Operator, ANIMAIDERT_OT):
...
class ANIMAIDERT_OT_blend_default(Operator, ANIMAIDERT_OT):
...
class ANIMAIDERT_OT_blend_infinite(Operator, ANIMAIDERT_OT):
...
class ANIMAIDERT_OT_blend_frame(Operator, ANIMAIDERT_OT):
...
class ANIMAIDERT_OT_blend_offset(Operator, ANIMAIDERT_OT):
...
class ANIMAIDERT_OT_tween(Operator, ANIMAIDERT_OT):
...
class ANIMAIDERT_OT_push_pull(Operator, ANIMAIDERT_OT):
...
class ANIMAIDERT_OT_smooth(Operator, ANIMAIDERT_OT):
...
class ANIMAIDERT_OT_time_offset(Operator, ANIMAIDERT_OT):
...
class ANIMAIDERT_OT_shear_right(Operator, ANIMAIDERT_OT):
    """Shift the value in time of selected or current keys """
...
class ANIMAIDERT_OT_shear_left(Operator, ANIMAIDERT_OT):
    """Shift the value in time of selected or current keys """
...
class ANIMAIDERT_OT_wave_noise(Operator, ANIMAIDERT_OT):
...
class ANIMAIDERT_OT_scale_left(Operator, ANIMAIDERT_OT):
...
class ANIMAIDERT_OT_scale_right(Operator, ANIMAIDERT_OT):
    """Increase or decrease the value of selected or current keys \n""" \
...
class ANIMAIDERT_OT_scale_average(Operator, ANIMAIDERT_OT):
    """Increase or decrease the value of selected or current keys \n""" \
...
class ANIMAIDERT_OT_tools_settings(Operator):
...
class ANIMAIDERT_OT_add_bookmark(Operator):
...
class ANIMAIDERT_OT_delete_bookmark(Operator):
...
class ANIMAIDERT_OT_push_bookmark(Operator):
...
class ANIMAIDERT_OT_get_ref_frame(Operator):
...
class ANIMAIDERT_OT_modifier(Operator):
...
class ANIMAIDERT_OT_path(Operator):
...
classes = (
    ANIMAIDERT_OT_tools_settings,
    ANIMAIDERT_OT_get_ref_frame,
    ANIMAIDERT_OT_push_bookmark,
    ANIMAIDERT_OT_add_bookmark,
    ANIMAIDERT_OT_delete_bookmark,
    ANIMAIDERT_OT_ease_to_ease,
    ANIMAIDERT_OT_ease,
    ANIMAIDERT_OT_blend_ease,
    ANIMAIDERT_OT_blend_neighbor,
    ANIMAIDERT_OT_blend_frame,
    ANIMAIDERT_OT_blend_default,
    ANIMAIDERT_OT_blend_offset,
    ANIMAIDERT_OT_push_pull,
    ANIMAIDERT_OT_scale_average,
    ANIMAIDERT_OT_scale_left,
    ANIMAIDERT_OT_scale_right,
    ANIMAIDERT_OT_smooth,
    ANIMAIDERT_OT_wave_noise,
    ANIMAIDERT_OT_time_offset,
    ANIMAIDERT_OT_shear_left,
    ANIMAIDERT_OT_shear_right,
    ANIMAIDERT_OT_tween,
    ANIMAIDERT_OT_blend_infinite,
)
