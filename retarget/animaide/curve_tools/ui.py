...
class ANIMAIDERT_PT_curve_tools:
...
class ANIMAIDERT_PT_curve_tools_ge(Panel, ANIMAIDERT_PT_curve_tools):
    bl_idname = 'ANIMAIDERT_PT_curve_tools_ge'
    bl_space_type = 'GRAPH_EDITOR'


class ANIMAIDERT_PT_curve_tools_de(Panel, ANIMAIDERT_PT_curve_tools):
    bl_idname = 'ANIMAIDERT_PT_curve_tools_de'
    bl_space_type = 'DOPESHEET_EDITOR'


class ANIMAIDERT_PT_curve_tools_3d(Panel, ANIMAIDERT_PT_curve_tools):
    bl_label = "On Frame Curve Tools"
    bl_idname = 'ANIMAIDERT_PT_curve_tools_3d'
    bl_space_type = 'VIEW_3D'


class ANIMAIDERT_UL_frame_bookmarks(UIList):
...
class ANIMAIDERT_PT_frame_bookmarks:
    ...
    def draw(self, context):
        ...
        row.template_list("ANIMAIDERT_UL_frame_bookmarks", "", tool, "frame_bookmarks", tool, "bookmark_index")
...
class ANIMAIDERT_PT_frame_bookmarks_ge(Panel, ANIMAIDERT_PT_frame_bookmarks):
    bl_idname = 'ANIMAIDERT_PT_frame_bookmarks_ge'
    bl_space_type = 'GRAPH_EDITOR'
    bl_parent_id = 'ANIMAIDERT_PT_curve_tools_ge'


class ANIMAIDERT_PT_frame_bookmarks_3d(Panel, ANIMAIDERT_PT_frame_bookmarks):
    bl_idname = 'ANIMAIDERT_PT_frame_bookmarks_3d'
    bl_space_type = 'VIEW_3D'
    bl_parent_id = 'ANIMAIDERT_PT_curve_tools_3d'


class ANIMAIDERT_PT_frame_bookmarks_de(Panel, ANIMAIDERT_PT_frame_bookmarks):
    bl_idname = 'ANIMAIDERT_PT_frame_bookmarks_de'
    bl_space_type = 'DOPESHEET_EDITOR'
    bl_parent_id = 'ANIMAIDERT_PT_curve_tools_de'


class ANIMAIDERT_MT_curve_tools(Menu):
    bl_idname = 'ANIMAIDERT_MT_curve_tools'
    bl_label = "Curve Tools"
...
class ANIMAIDERT_MT_tweak(Menu):
    bl_idname = 'ANIMAIDERT_MT_tweak'
    bl_label = "Tweak"
...
def draw_bookmarks(self, context):
    layout = self.layout
    row = layout.row(align=False)
    row.popover(panel="ANIMAIDERT_PT_frame_bookmarks_ge", text="", icon='BOOKMARKS')
    row.separator()


classes = (
    ANIMAIDERT_PT_curve_tools_ge,
    ANIMAIDERT_PT_curve_tools_de,
    ANIMAIDERT_PT_curve_tools_3d,
    ANIMAIDERT_UL_frame_bookmarks,
    ANIMAIDERT_PT_frame_bookmarks_ge,
    ANIMAIDERT_PT_frame_bookmarks_de,
    ANIMAIDERT_PT_frame_bookmarks_3d,
    ANIMAIDERT_MT_curve_tools,
    ANIMAIDERT_MT_tweak,
)
