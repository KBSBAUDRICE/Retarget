...
class ANIMAIDERT_OT_modal_test(Operator):
...
class ANIMAIDERT_OT_activate_anim_offset(Operator):
...
class ANIMAIDERT_OT_deactivate_anim_offset(Operator):
...
class ANIMAIDERT_OT_add_anim_offset_mask(Operator):
    ...
    def finish_mask(self, context):
        ...
        context.scene.animaidert.anim_offset.mask_in_use = True
        context.area.tag_redraw()
...
class ANIMAIDERT_OT_delete_anim_offset_mask(Operator):
...
class ANIMAIDERT_OT_anim_offset_settings(Operator):
...
classes = (
    # ANIMAIDERT_OT_modal_test,
    ANIMAIDERT_OT_add_anim_offset_mask,
    ANIMAIDERT_OT_activate_anim_offset,
    ANIMAIDERT_OT_deactivate_anim_offset,
    ANIMAIDERT_OT_delete_anim_offset_mask,
    ANIMAIDERT_OT_anim_offset_settings,
)
